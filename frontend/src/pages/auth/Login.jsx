...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0EB] flex flex-col items-center justify-center px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">Sign in to your CandyCraft account</p>
      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="flex justify-end mt-1">
              <button type="button" className="text-xs text-gray-400 hover:text-pink-500 transition-colors">
                Forgot password?
              </button>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link to="/register" className="font-bold text-gray-800 hover:text-pink-500 transition-colors">
            Register here
          </Link>
        </p>
      </div>
