    ...
    <div className="min-h-screen bg-[#F5F0EB]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible" className="space-y-6">
            <div className="bg-white rounded-2xl shadow-sm p-7">
              ...
              <ul className="space-y-5">
                {/* Email */}
                <motion.li whileHover={{ x: 4 }} className="flex items-start gap-4">
          ...
          <motion.div custom={1} variants={fadeUp} initial="hidden" animate="visible" className="bg-white rounded-2xl shadow-sm p-7">
