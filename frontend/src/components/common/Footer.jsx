        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <motion.div custom={3} variants={fadeUp}>
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <motion.a whileHover={{ scale: 1.15, y: -2 }} whileTap={{ scale: 0.9 }} href="#" className="w-9 h-9 bg-gray-700 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors">
              ...
              {/* Instagram */}
              <motion.a whileHover={{ scale: 1.15, y: -2 }} whileTap={{ scale: 0.9 }} href="#" className="w-9 h-9 bg-gray-700 hover:bg-pink-500 rounded-full flex items-center justify-center transition-colors">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Twitter / X */}
              <motion.a whileHover={{ scale: 1.15, y: -2 }} whileTap={{ scale: 0.9 }} href="#" className="w-9 h-9 bg-gray-700 hover:bg-sky-500 rounded-full flex items-center justify-center transition-colors">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
